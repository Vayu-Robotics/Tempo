...
using GetAvailableSensors_Request =
  tempo_sensors_ros_bridge::srv::GetAvailableSensors_Request_<std::allocator<void>>;
...
using GetAvailableSensors_Response =
  tempo_sensors_ros_bridge::srv::GetAvailableSensors_Response_<std::allocator<void>>;
