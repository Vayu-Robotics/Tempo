...
using SetGeographicReference_Request =
  tempo_geographic_ros_bridge::srv::SetGeographicReference_Request_<std::allocator<void>>;
...
using SetGeographicReference_Response =
  tempo_geographic_ros_bridge::srv::SetGeographicReference_Response_<std::allocator<void>>;
